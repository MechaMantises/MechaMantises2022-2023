...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(16, 0, 2,
    ...
    public static double GEAR_RATIO = 1*0.984511; // output (wheel) speed / input (motor) speed
    ...
    public static double MAX_ANG_VEL = Math.toRadians(281.5132680765423);
